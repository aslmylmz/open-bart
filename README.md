...
[![Latest release](https://img.shields.io/github/v/release/aslmylmz/metu-risk-persona)](https://github.com/aslmylmz/metu-risk-persona/releases/latest)
...
1. **Download** the Windows installer from the
   [latest release](https://github.com/aslmylmz/metu-risk-persona/releases/latest).
...
[Read the Docs](https://metu-risk-persona.readthedocs.io)). Nothing leaves the
...
```bash
pip install "metu-risk-persona @ git+https://github.com/aslmylmz/metu-risk-persona"
...
[technical documentation](https://metu-risk-persona.readthedocs.io).
...
[docs/](docs/) and builds on [Read the Docs](https://metu-risk-persona.readthedocs.io):
